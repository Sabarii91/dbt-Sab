-- Source query for comprehensive_compare: same transform as stg_customers, full table (no delta filter).
-- Referenced by TEST_CONFIG.test_query_model (Option A full-load test runner).
SELECT
